...
pub(crate) fn parse_number(input: Span) -> ParseResult<Number> {
    alt((
...
pub(crate) fn parse_float(input: Span) -> ParseResult<f64> {
    map_res(
        recognize(tuple((
            opt(token('-')),
            digit0,
...
pub(crate) fn parse_hex_float(input: Span) -> ParseResult<f64> {
    map_res(
        recognize(tuple((
            opt(token('-')),
            tag("0x"),
...
pub(crate) fn parse_integer<'src>(input: Span<'src>) -> ParseResult<'src, Number> {
    alt((
        map_res(
...
pub(crate) fn parse_hex_integer(input: Span) -> ParseResult<i64> {
...
mod tests {
    ...
    #[test]
    pub(crate) fn parses_float_constant() -> anyhow::Result<()> {
        let float = "1.";
    ...
    #[test]
    pub(crate) fn parses_float_constant_decimals() -> anyhow::Result<()> {
        let float = "1.00";
    ...
    #[test]
    pub(crate) fn parses_float_constant_exponent() -> anyhow::Result<()> {
        let float = "1.e10";
    ...
    #[test]
    pub(crate) fn parses_float_constant_neg_exponent() -> anyhow::Result<()> {
        let float = "1.e-10";
    ...
    #[test]
    pub(crate) fn parses_hex_float_constant() -> anyhow::Result<()> {
        let float = "0x1F.0p-1";
    ...
    #[test]
    pub(crate) fn parses_integer_constant() -> anyhow::Result<()> {
    ...
    #[test]
    pub(crate) fn parses_negative_integer_constant() -> anyhow::Result<()> {
        let negative = "-10";
    ...
    #[test]
    pub(crate) fn parses_hex_constant_wrapping() -> anyhow::Result<()> {
    ...
    #[test]
    pub(crate) fn parses_hex_constant_wrapping_2() -> anyhow::Result<()> {
