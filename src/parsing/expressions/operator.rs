...
/// leaf we found.
pub(crate) fn parse_exp_expr<'src, 'chunk>(
    input: Span<'src>,
...
pub(crate) fn parse_unop_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    alt((
...
pub(crate) fn parse_muldivmod_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
...
pub(crate) fn parse_addsub_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_concat_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_right_assoc_binop(
...
pub(crate) fn parse_shift_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_bitand_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_bitxor_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_bitor_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_logical_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_and_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
pub(crate) fn parse_or_expr<'src, 'chunk>(
    input: Span<'src>,
    alloc: &'chunk ASTAllocator,
) -> ParseResult<'src, Expression<'chunk>> {
    parse_left_assoc_binop(
...
mod tests {
    ...
    #[test]
    pub(crate) fn parses_exponentiation() -> anyhow::Result<()> {
        let src = "1 ^ 2";
    ...
    #[test]
    pub(crate) fn parses_unary_not() -> anyhow::Result<()> {
        let src = "not 1";
    ...
    #[test]
    pub(crate) fn parses_unary_not_handles_ident() -> anyhow::Result<()> {
        let src = "not notabc";
    ...
    #[test]
    pub(crate) fn parses_unary_len() -> anyhow::Result<()> {
        let src = "#1";
    ...
    #[test]
    pub(crate) fn parses_unary_minus() -> anyhow::Result<()> {
        let src = "-1";
    ...
    #[test]
    pub(crate) fn parses_unary_bitnot() -> anyhow::Result<()> {
        let src = "~1";
    ...
    #[test]
    pub(crate) fn parses_times() -> anyhow::Result<()> {
        let src = "1 * 2";
    ...
    #[test]
    pub(crate) fn parses_div() -> anyhow::Result<()> {
        let src = "1 / 2";
    ...
    #[test]
    pub(crate) fn parses_idiv() -> anyhow::Result<()> {
        let src = "1 // 2";
    ...
    #[test]
    pub(crate) fn parses_modulo() -> anyhow::Result<()> {
        let src = "1 % 2";
    ...
    #[test]
    pub(crate) fn parses_add() -> anyhow::Result<()> {
        let src = "1 + 2";
    ...
    #[test]
    pub(crate) fn parses_minus() -> anyhow::Result<()> {
        let src = "1 - 2";
    ...
    #[test]
    pub(crate) fn parses_concat() -> anyhow::Result<()> {
        let src = "1 .. 2";
    ...
    #[test]
    pub(crate) fn parses_shiftl() -> anyhow::Result<()> {
        let src = "1 << 2";
    ...
    #[test]
    pub(crate) fn parses_shiftr() -> anyhow::Result<()> {
        let src = "1 >> 2";
    ...
    #[test]
    pub(crate) fn parses_bitand() -> anyhow::Result<()> {
        let src = "1 & 2";
    ...
    #[test]
    pub(crate) fn parses_bitxor() -> anyhow::Result<()> {
        let src = "1 ~ 2";
    ...
    #[test]
    pub(crate) fn parses_bitor() -> anyhow::Result<()> {
        let src = "1 | 2";
    ...
    #[test]
    pub(crate) fn parses_lt() -> anyhow::Result<()> {
        let src = "1 < 2";
    ...
    #[test]
    pub(crate) fn parses_le() -> anyhow::Result<()> {
        let src = "1 <= 2";
    ...
    #[test]
    pub(crate) fn parses_gt() -> anyhow::Result<()> {
        let src = "1 > 2";
    ...
    #[test]
    pub(crate) fn parses_ge() -> anyhow::Result<()> {
        let src = "1 >= 2";
    ...
    #[test]
    pub(crate) fn parses_ne() -> anyhow::Result<()> {
        let src = "1 ~= 2";
    ...
    #[test]
    pub(crate) fn parses_eq() -> anyhow::Result<()> {
        let src = "1 == 2";
    ...
    #[test]
    pub(crate) fn parses_and() -> anyhow::Result<()> {
        let src = "1 and 2";
    ...
    #[test]
    pub(crate) fn parses_and_handles_ident() -> anyhow::Result<()> {
        let src = "1 and and2";
    ...
    #[test]
    pub(crate) fn parses_or() -> anyhow::Result<()> {
        let src = "1 or 2";
    ...
    #[test]
    pub(crate) fn parses_or_handles_ident() -> anyhow::Result<()> {
        let src = "1 or or2";
    ...
    #[test]
    pub(crate) fn parses_multi_left_assoc() -> anyhow::Result<()> {
        let src = "1 == 2 <= 3 >= 4";
    ...
    #[test]
    pub(crate) fn parses_multi_right_assoc() -> anyhow::Result<()> {
        let src = "1 .. 2 .. 3 .. 4";
    ...
    #[test]
    pub(crate) fn parses_multi_right_assoc_precedence() -> anyhow::Result<()> {
        let src = "1 .. 2 ^ 3 .. 4";
    ...
    #[test]
    pub(crate) fn parse_precedence_simple_down() -> anyhow::Result<()> {
    ...
    #[test]
    pub(crate) fn parses_precedence_up() -> anyhow::Result<()> {
    ...
    #[test]
    pub(crate) fn parses_precedence_down() -> anyhow::Result<()> {
