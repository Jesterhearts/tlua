...
pub(crate) fn parse_string(input: Span) -> ParseResult<ConstantString> {
    alt((
...
mod tests {
    ...
    #[test]
    pub(crate) fn single_quoted() -> anyhow::Result<()> {
        let src = r#"'a string'"#;

        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
    ...
    #[test]
    pub(crate) fn double_quoted() -> anyhow::Result<()> {
        let src = r#""a string""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_bell() -> anyhow::Result<()> {
        let src = r#""\a""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_backspace() -> anyhow::Result<()> {
        let src = r#""\b""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_formfeed() -> anyhow::Result<()> {
        let src = r#""\f""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_newline() -> anyhow::Result<()> {
        let src = r#""\n""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_carriage_return() -> anyhow::Result<()> {
        let src = r#""\r""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_tab() -> anyhow::Result<()> {
        let src = r#""\t""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_vertical_tab() -> anyhow::Result<()> {
        let src = r#""\v""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_backslash() -> anyhow::Result<()> {
        let src = r#""\\""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_double_quote() -> anyhow::Result<()> {
        let src = r#""\"""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_single_quote() -> anyhow::Result<()> {
        let src = r#""\'""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_z() -> anyhow::Result<()> {
        let src = r#""\z  
            a string""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_z_empty() -> anyhow::Result<()> {
        let src = r#""\za string""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_continuation_newline() -> anyhow::Result<()> {
        let src = "\"line1 \\\n a string\"";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_continuation_carriage_return() -> anyhow::Result<()> {
    ...
    #[test]
    pub(crate) fn escape_continuation_carriage_return_newline() -> anyhow::Result<()> {
        let src = "\"line1 \\\r\n a string\"";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_continuation_newline_carriage_return() -> anyhow::Result<()> {
        let src = "\"line1 \\\n\r a string\"";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_unicode() -> anyhow::Result<()> {
        let src = r#""\u{2764}""#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn escape_unicode_allow_invalid() -> anyhow::Result<()> {
    ...
    #[test]
    pub(crate) fn raw_string() -> anyhow::Result<()> {
        let src = r#"[[]]"#;
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn raw_string_extended() -> anyhow::Result<()> {
        let src = "[===[]===]";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn raw_string_extended_unbalanced() -> anyhow::Result<()> {
        let src = "[===[]==]===]";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn raw_string_first_newline_skip() -> anyhow::Result<()> {
        let src = "[===[\n]===]";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
    ...
    #[test]
    pub(crate) fn raw_string_newline_replace() -> anyhow::Result<()> {
        let src = "[===[\nline1\nline2\r\nline3\n\rline4\rline5\n\nline6\r\rline7\r\n\nline8\r\n\rline9\nline10\n\r\r\n\n\rline11]===]";
        let result = final_parser(parse_string)(Span::new(src.as_bytes()))
            .map_err(|e: InternalLuaParseError| e.map_locations(LuaParseError::from))?;
