...
mod tests {
    ...
    #[test]
    pub(crate) fn parses_empty_args() -> anyhow::Result<()> {
        let src = "()";
    ...
    #[test]
    pub(crate) fn parses_parenthetical_args() -> anyhow::Result<()> {
        let src = "(nil, nil, nil)";
    ...
    #[test]
    pub(crate) fn parses_table_args() -> anyhow::Result<()> {
        let src = "{}";
    ...
    #[test]
    pub(crate) fn parses_string_args() -> anyhow::Result<()> {
        let src = "\"arg\"";
